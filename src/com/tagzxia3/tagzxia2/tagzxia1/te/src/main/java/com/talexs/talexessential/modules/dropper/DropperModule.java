package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.talexessential.modules.dropper;
...
public class DropperModule extends BaseModule {
    ...
    private Map<World, DropperWorld> worldDropperWorldMap = new HashMap<>();
    ...
    public void onDeath(PlayerDeathEvent event) {
        ...
        DropperWorld dw = worldDropperWorldMap.get(player.getWorld());
        if ( dw == null ) return;
    ...
    public void onEnable() {
        ...
        keys.forEach(worldName -> {
            DropperWorld dw = new DropperWorld(yaml, worldName);
