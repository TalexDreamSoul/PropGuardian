package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.items.alchemy;
...
@ItemClass(AlchemyClass.class)
public abstract class BaseAlchemyItem extends SoulTechItem implements IHasUnlockConditions, INeedPrepositions {
    public BaseAlchemyItem(@NotNull String ID, @NotNull ItemStack stack) {
        super(ID, stack);
    }
