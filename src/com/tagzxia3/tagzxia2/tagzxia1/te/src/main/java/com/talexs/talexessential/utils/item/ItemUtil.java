package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.talexessential.utils.item;
...
public final class ItemUtil {
    ...
    public static Component translateName(ItemStack stack) {
    ...
    @Deprecated
    public static String getName(ItemStack stack, boolean amo) {
        if ( stack == null ) return "";
        if ( stack.getItemMeta() == null || stack.getItemMeta().getDisplayName() == null ) return stack.getType().name() + (amo ? " x" + stack.getAmount() : "");
        return stack.getItemMeta().getDisplayName() + (amo ? " x" + stack.getAmount() : "");
    }

    @Deprecated
    public static String getName(ItemStack stack, int amo) {
        if ( stack == null ) return "";
        if ( stack.getItemMeta() == null ) return stack.getType().name() + "x" + amo;
        return stack.getItemMeta().getDisplayName() + "x" + amo;
    }
