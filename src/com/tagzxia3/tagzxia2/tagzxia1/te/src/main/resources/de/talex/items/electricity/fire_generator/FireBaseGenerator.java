package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.resources.de.talex.items.electricity.fire_generator;
...
//                                loc.getChunk().un
        ...
        }.runTaskTimerAsynchronously(TalexEssential.getInstance(), 0, 2);
