package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.items.soul;

import com.talexs.soultech.classifies.AlchemyClass;
import com.talexs.soultech.classifies.SoulClass;
...
@ItemClass(SoulClass.class)
public abstract class BaseSoulItem extends SoulTechItem implements IHasUnlockConditions, INeedPrepositions {
    public BaseSoulItem(@NotNull String ID, @NotNull ItemStack stack) {
        super(ID, stack);
    }
