package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.internal.protector;
...
public class ProtectorAddon extends BaseAddon {
    ...
    @Getter
    private final LinkedList<IProtector> protectors = new LinkedList<>();

    public ProtectorAddon regProtector(IProtector protector) {
    ...
    public IProtector unRegProtector(IProtector protector) {
