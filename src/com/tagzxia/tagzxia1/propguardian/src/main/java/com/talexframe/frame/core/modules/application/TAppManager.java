package com.tagzxia.tagzxia1.propguardian.src.main.java.com.talexframe.frame.core.modules.application;
...
public class TAppManager {
    ...
    private final ConcurrentMap<Class<?>, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.application.TApp> controllers = new ConcurrentHashMap<>(32);
    private final ConcurrentMap<com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.application.TApp, String> controllerPluginMap = new ConcurrentHashMap<>(32);
     ...
     */
    @SneakyThrows
    public boolean registerController(WebPlugin plugin, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.application.TApp controller) {
