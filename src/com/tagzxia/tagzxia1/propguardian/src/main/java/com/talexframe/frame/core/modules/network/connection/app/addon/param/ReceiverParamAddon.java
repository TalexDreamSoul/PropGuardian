package com.tagzxia.tagzxia1.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param;

import cn.hutool.core.convert.ConvertException;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.TObjParam;
import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.TParam;
import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.TUrlParam;
...
public class ReceiverParamAddon extends ReceiverAddon {
    ...
    public boolean onPreInvokeMethod(MethodAppReceiver methodAppReceiver, WrappedResponse wr) {
        ...
        for ( Parameter parameter : methodAppReceiver.getMethod().getParameters() ) {
            ...
            com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.TParam tParam = parameter.getAnnotation(com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.TParam.class);

            if( tParam == null ) {

                com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.TObjParam tObjParam = parameter.getAnnotation(TObjParam.class);
    ...
    public boolean processUrlParam(MethodAppReceiver methodReceiver, Parameter parameter, WrappedResponse wr) {
        ...
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.TUrlParam tUrlParam = parameter.getAnnotation(TUrlParam.class);
