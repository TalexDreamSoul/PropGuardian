package com.tagzxia.tagzxia1.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core;
...
import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.PluginInfo;
import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin;
...
public class PluginManager {
    ...
    @Getter
    private final Map<String, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin> pluginHashMap = new HashMap<>();
        ...
        for ( Enumeration<JarEntry> en = jarFile.entries(); en.hasMoreElements(); ) {
            ...
            if ( jarEntry.getName().contains("plugin.yml") ) {
                ...
                try {
                    ...
                    com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.PluginInfo info = new com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.PluginInfo()
                            ...
                            .setSupportVersion(com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.PluginInfo.PluginSupportVersion.valueOf(json.get("supportVersion").getAsString()));
    ...
    public void loadPlugin(String pluginName) {
        ...
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.PluginInfo info = wInfo.getInfo();
        ...
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin webPlugin = getPluginInstance(info.getPluginName(), info);
    ...
    public boolean unloadPlugin(String pluginName) {
        ...
        if ( !pluginHashMap.containsKey(pluginName) ) {
            ...
            Map<String, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin> list = new HashMap<>();

            for ( Map.Entry<String, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin> entry : pluginHashMap.entrySet() ) {
            ...
            if ( list.size() > 0 ) {
                ...
                for ( Map.Entry<String, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin> entry : list.entrySet() ) {

                    com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.PluginInfo info = entry.getValue().getInfo();
        ...
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin plugin = this.pluginHashMap.get(pluginName);
    ...
    @SneakyThrows
    private com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin getPluginInstance(String pluginName, PluginInfo info) {
        ...
        if ( !( instance instanceof com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin) ) {
        ...
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.core.WebPlugin wp = (WebPlugin) instance;
