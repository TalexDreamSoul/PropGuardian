package com.tagzxia.tagzxia1.propguardian.src.main.java.com.talexframe.frame.core.pojo.dao.factory.mysql.builder.insert;

import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.pojo.dao.factory.mysql.builder.insert.InsertType;
...
public class SqlInsertBuilder extends SqlBuilder {
    ...
    @Getter
    @Setter
    private com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.pojo.dao.factory.mysql.builder.insert.InsertType insertType;

    public SqlInsertBuilder(String tableName, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.pojo.dao.factory.mysql.builder.insert.InsertType insertType) {
    ...
    public SqlInsertBuilder(String tableName) {
        ...
        this(tableName, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.pojo.dao.factory.mysql.builder.insert.InsertType.IGNORE);
