package com.tagzxia.tagzxia1.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.yaml;

import cn.hutool.core.util.StrUtil;
import com.google.common.collect.HashMultimap;
import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.yaml.YamlConfig;
 ...
 */
public class YamlConfigAdapter extends PluginCompAdapter<com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.yaml.YamlConfig> {

    private static final HashMultimap<Class<?>, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.yaml.YamlConfig> map = HashMultimap.create();

    @SneakyThrows
    @Override
    protected boolean injectWithInstance(PluginScanner scanner, WebPlugin webPlugin, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.yaml.YamlConfig instance) {
    ...
    public boolean logoutInstance(PluginScanner scanner, WebPlugin webPlugin, Class<? extends FrameCreator> clazz) {
        ...
        Set<com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.yaml.YamlConfig> configs = map.get(clazz);
