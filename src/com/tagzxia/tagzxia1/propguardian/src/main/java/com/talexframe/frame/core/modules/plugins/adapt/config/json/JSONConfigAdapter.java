package com.tagzxia.tagzxia1.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.json;
...
import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.json.JSONConfig;
 ...
 */
public class JSONConfigAdapter extends PluginCompAdapter<com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.json.JSONConfig> {

    private static final HashMultimap<Class<?>, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.json.JSONConfig> map = HashMultimap.create();

    @SneakyThrows
    @Override
    protected boolean injectWithInstance(PluginScanner scanner, WebPlugin webPlugin, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.json.JSONConfig instance) {
    ...
    public boolean logoutInstance(PluginScanner scanner, WebPlugin webPlugin, Class<? extends FrameCreator> clazz) {
        ...
        Set<com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.plugins.adapt.config.json.JSONConfig> configs = map.get(clazz);
