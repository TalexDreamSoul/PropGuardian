package com.tagzxia.tagzxia1.te.src.main.java.com.talexs.talexessential.modules.gender;
...
public class ChooseGenderGUI extends MenuBasic {
    ...
    public void SetupForPlayer(Player player) {
        ...
        com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.gender.GenderType gt = com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.gender.GenderType.valueOf(gender);

        int startSlot = 19;

        for ( com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.gender.GenderType type : GenderType.values() ) {
