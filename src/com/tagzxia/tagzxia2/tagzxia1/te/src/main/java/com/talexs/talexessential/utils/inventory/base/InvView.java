...
public abstract class InvView implements IInvView {
    ...
    private final List<InvUI> uis = new ArrayList<>();
    ...
    @Override
    public @Nullable InvUI getPage(int page) {
        this.checkInvUis();
    ...
    @Override
    public @Nullable InvUI getCurrentPage() {
    ...
    public @Nullable IInvClickableItem getItem(int page, int slot) {
        ...
        InvUI currentPage = getPage(page);
    ...
    public IInvView setItem(int x, int y, IInvClickableItem item) {
        ...
        InvUI currentPage = getCurrentPage();
    ...
    public IInvView addItem(IInvClickableItem item) {
        ...
        InvUI lastInventory = uis.get(this.uis.size() - 1);
    ...
    public IInvView createNewInvUI() {
        InvUI ui = new InvUI(this, this.defaultTitle, this.rows);
