...
public class InventoryPainter implements IInventoryPainter {
    ...
    public InventoryPainter drawThese(int... slots) {
            ...
            for ( int slot : slots ) {
                ...
                InventoryUI.ClickableItem stack = onDrawBorder(slot);
    ...
    public InventoryUI.ClickableItem onDrawBorder(int slot) {
        ...
        return new InventoryUI.EmptyCancelledClickableItem(new ItemBuilder(Material.BLACK_STAINED_GLASS_PANE).setDurability((short) 7).setName("§7*").toItemStack());
