package com.tagzxia2.te.src.main.java.com.talexs.talexessential.modules.luckybag;
...
public class LuckyBagModule extends BaseModule {
    ...
    public void open(PlayerInteractEvent event) {
        ...
        if ( meta.getDisplayName().contains(
            ...
            com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.BaseLuckyBag.increasePlayerOpenedAmo(pd, "coal");
            new com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.CoalLuckyBag().open(player);
        } else if ( meta.getDisplayName().contains(
                ChatColor.translateAlternateColorCodes('&', "&c儒学龙钟 &8&l· &a&l新春福袋 &8&l· &e晨曦光辉")
        )) {
            event.setCancelled(true);
            com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.BaseLuckyBag.increasePlayerOpenedAmo(pd, "iron");
            new com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.IronLuckyBag().open(player);
        } else if ( meta.getDisplayName().contains(
                ChatColor.translateAlternateColorCodes('&', "&c金蚕龙态 &8&l· &a&l新春福袋 &8&l· &e金光晨曦")
        )) {
            event.setCancelled(true);
            com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.BaseLuckyBag.increasePlayerOpenedAmo(pd, "gold");
            new com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.GoldLuckyBag().open(player);
        } else if ( meta.getDisplayName().contains(
                ChatColor.translateAlternateColorCodes('&', "&c烔欣龙融 &8&l· &a&l新春福袋 &8&l· &e绣绿晨曦")
        )) {
            event.setCancelled(true);
            com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.BaseLuckyBag.increasePlayerOpenedAmo(pd, "copper");
            new com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.CopperLuckyBag().open(player);
        } else if ( meta.getDisplayName().contains(
                ChatColor.translateAlternateColorCodes('&', "&c钻湘龙奔 &8&l· &a&l新春福袋 &8&l· &e花蓝晨曦")
        )) {
            event.setCancelled(true);
            com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.BaseLuckyBag.increasePlayerOpenedAmo(pd, "diamond");
...
//        if ( !doEnable(event.getPlayer().getWorld()) ) return;
        ...
        if ( event.getBlock().getType().name().contains("ORE") ) {
            ...
            if ( random.nextDouble() < 0.2 ) {
                new com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.GoldLuckyBag().drop2Loc(event.getBlock().getLocation(), random.nextInt(2));
            } else if ( random.nextDouble() < 0.4 ) {
                new com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.IronLuckyBag().drop2Loc(event.getBlock().getLocation(), random.nextInt(3));
            } else {
                new com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.luckybag.CoalLuckyBag().drop2Loc(event.getBlock().getLocation(), random.nextInt(5));
            }
