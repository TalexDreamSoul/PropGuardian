package com.tagzxia.tagzxia1.te.src.main.java.com.talexs.talexessential.modules.realm;
...
//            RealmAddons.INS.regAddon(realmFlag);
    ...
    public static List<com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm> realms = new ArrayList<>();
    ...
    public static @Nullable com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm getRealmByLoc(Location loc) {
        for ( com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm realm : realms ) {
    ...
    public static @Nullable com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm getRealmByName(String name) {
        for ( com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm realm : realms ) {
    ...
    public static List<com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm> getRealmByOwner(String owner) {
        List<com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm> realms = new ArrayList<>();
        for ( com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm realm : realms ) {
    ...
    private void loadAllRealms() {
        ...
        while ( rs != null && rs.next() ) {
            ...
            realms.add(new com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm().de(rs));
    ...
    public void onMove(EntityMoveEvent event) {
        ...
        com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm fromRealm = getRealmByLoc(from);
        com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm toRealm = getRealmByLoc(to);
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm realm = getRealmByLoc(to);
        if ( realm == null ) {
            goCreate(event);
            return;
        }
...
//                .onBlockExploded(pr, event, block);
    ...
    private void goCreate(PlayerInteractEvent event) {
        ...
        List<com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm> playerRealms = getRealmByOwner(player.getName());
        ...
        double size = com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmArea.calcLocSize(loc1, loc2);
        ...
        com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmArea.BoundingSphere boundingSphere = com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmArea.BoundingSphere.getBoundingSphere(loc1, loc2);

        for (com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm realm : realms) {
            if ( !com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmArea.BoundingSphere.doSphereIntersect(boundingSphere, realm.getRealmArea().getSphere()) ) {
                realmCreateMap.remove(player.getName());
                user
        ...
        user.chatFunc(new ChatFunction() {
            ...
            public void execute(String value) {
                ...
                com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm realm = getRealmByName(value);
                if ( realm != null ) {
                ...
                com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm pr = new com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm();
    ...
    public void onIgnite(BlockBurnEvent event) {
        ...
        com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm pr = getRealmByLoc(to);
        if ( pr == null ) return;
...
//            event.blockList().remove(block);
    ...
    public void onPVP(EntityDamageByEntityEvent event) {
        ...
        com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm pr = getRealmByLoc(location);
        if ( pr == null ) return;
    ...
    public void onPVE(EntityDamageByEntityEvent event) {
        ...
        if ( damager instanceof Projectile ) {
            ...
            if ( shooter instanceof Player ) {
                ...
                if ( !pr.getFlag(com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmSets.ANIMAL) ) {
                    event.setCancelled(true);
...
//        }
    ...
    public void onLiquidForm(BlockFromToEvent event) {
        ...
        com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm toPr = getRealmByLoc(toLoc);
        com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.PlayerRealm fromPr = getRealmByLoc(fromLoc);
