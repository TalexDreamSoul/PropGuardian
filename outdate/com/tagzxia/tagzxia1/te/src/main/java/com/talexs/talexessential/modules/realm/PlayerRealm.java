...
public class PlayerRealm {
    ...
    private com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmArea realmArea;
    ...
    public boolean doVisible(Player player) {
        ...
        return getFlag(com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmSets.VISIBLE);
    }

    public boolean use(Player player) {
        if ( doPlayerHasPer(player) ) return true;

        return getFlag(com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmSets.USE);
    }
    ...
    @Deprecated
    public boolean getFlag(com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmSets set) {
        return getFlag(set.name());
    }

    @Deprecated
    public void setFlag(com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmSets set, boolean value) {
...
//        return info.getBoolean("Flags.allowOthersTeleport", false);
    ...
    public boolean onEntityEscape(EntityType type) {
        ...
        if (animals.contains(type)) return this.getFlag(com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmSets.ANIMAL.name(), DENY);

        return !this.getFlag(com.tagzxia.te.src.main.java.com.talexs.talexessential.modules.realm.RealmSets.MOB.name(), DENY);
    }
