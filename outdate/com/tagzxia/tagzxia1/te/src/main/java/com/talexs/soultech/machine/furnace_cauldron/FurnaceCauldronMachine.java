package com.tagzxia.tagzxia1.te.src.main.java.com.talexs.soultech.machine.furnace_cauldron;
...
public class FurnaceCauldronMachine extends BaseMachine implements IMachineBuilder {
    ...
    private final HashMap<String, com.tagzxia.te.src.main.java.com.talexs.soultech.machine.furnace_cauldron.FurnaceCauldronObject> map = new HashMap<>(64);
    ...
    private void subRun() {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for ( Map.Entry<String, com.tagzxia.te.src.main.java.com.talexs.soultech.machine.furnace_cauldron.FurnaceCauldronObject> entry : new HashSet<>(map.entrySet()) ) {

                    com.tagzxia.te.src.main.java.com.talexs.soultech.machine.furnace_cauldron.FurnaceCauldronObject obj = entry.getValue();
...
//                        ParticleUtil.drawBlockParticleLine(block, Particle.DRIP_LAVA, 1.05);
    ...
    private void process(Player player, PlayerInteractEvent event) {
        ...
        com.tagzxia.te.src.main.java.com.talexs.soultech.machine.furnace_cauldron.FurnaceCauldronObject obj = map.get(str);

        if ( obj == null ) {

            obj = new com.tagzxia.te.src.main.java.com.talexs.soultech.machine.furnace_cauldron.FurnaceCauldronObject();
    ...
    public String onSave() {
        ...
        for ( Map.Entry<String, com.tagzxia.te.src.main.java.com.talexs.soultech.machine.furnace_cauldron.FurnaceCauldronObject> entry : map.entrySet() ) {
