package com.tagzxia.tagzxia1.te.src.main.java.com.talexs.talexessential.utils;
...
public class NumberUtils {
    ...
    private static final String[] RM_UNIT = { "I", "||", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XI", "XII", "XIII", "XIV", "XV", "XVI", "XVII", "XVIII", "XIX", "XX" };

    private NumberUtils() {}

    public static String level2romaNum(int num) {

        num = Math.max(1, Math.min(num, RM_UNIT.length - 1));
        return RM_UNIT[num - 1];
