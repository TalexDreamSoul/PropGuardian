package com.tagzxia.tagzxia1.te.src.main.resources.de.talex.machine.griddle;

import com.tagzxia.te.src.main.resources.de.talex.machine.griddle.GriddleObject;
import com.tagzxia.te.src.main.resources.de.talex.machine.griddle.GriddleRecipe;
...
public class GriddleMachine extends BaseMachine {
    ...
    public static final HashMap<String, com.tagzxia.te.src.main.resources.de.talex.machine.griddle.GriddleObject> map = new HashMap<>(64);
    ...
    private void process(PlayerData playerData, PlayerInteractEvent event) {
        ...
        com.tagzxia.te.src.main.resources.de.talex.machine.griddle.GriddleObject obj = map.get(str);
    ...
    public boolean onOpenRecipeView(GuiderBook guiderBook) {
        ...
        if ( !( recipeObject instanceof com.tagzxia.te.src.main.resources.de.talex.machine.griddle.GriddleRecipe) ) {

            return false;

        }

        com.tagzxia.te.src.main.resources.de.talex.machine.griddle.GriddleRecipe gr = (GriddleRecipe) recipeObject;
    ...
    public String onSave() {
        ...
        for ( Map.Entry<String, com.tagzxia.te.src.main.resources.de.talex.machine.griddle.GriddleObject> entry : map.entrySet() ) {
