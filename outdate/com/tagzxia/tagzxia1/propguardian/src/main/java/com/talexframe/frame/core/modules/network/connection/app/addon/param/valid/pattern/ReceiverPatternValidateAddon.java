package com.tagzxia.tagzxia1.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.valid.pattern;
...
public class ReceiverPatternValidateAddon extends ReceiverValidateAddon<com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.valid.pattern.TPatternValid> {
    ...
    @Override
    public boolean validate(WrappedResponse wr, com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.param.valid.pattern.TPatternValid tPatternValid, Object addedParam) {
