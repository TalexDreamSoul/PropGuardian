package com.tagzxia.tagzxia1.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.method;

import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.method.TReqBody;
import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.method.TReqSupportMethod;
...
public class ReceiverMethodAddon extends ReceiverAddon {
    ...
    public boolean onPreCheckAppReceiver(ClassAppReceiver classAppReceiver, WrappedResponse wr) {
        ...
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.method.TReqSupportMethod supportMethod = classAppReceiver.getOwnClass().getAnnotation(com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.method.TReqSupportMethod.class);
    ...
    public boolean onPreInvokeMethod(MethodAppReceiver methodAppReceiver, WrappedResponse wr) {
        ...
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.method.TReqBody tReqBody = methodAppReceiver.getMethod().getAnnotation(TReqBody.class);
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.method.TReqSupportMethod supportMethod = methodAppReceiver.getMethod().getAnnotation(com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.method.TReqSupportMethod.class);
