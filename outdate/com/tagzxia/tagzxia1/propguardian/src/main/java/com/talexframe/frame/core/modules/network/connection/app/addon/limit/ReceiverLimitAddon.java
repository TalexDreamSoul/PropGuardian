package com.tagzxia.tagzxia1.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.limit;

import com.google.common.util.concurrent.RateLimiter;
import com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.limit.TReqLimit;
...
public class ReceiverLimitAddon extends ReceiverAddon {
    ...
    public boolean onPreCheckAppReceiver(ClassAppReceiver classAppReceiver, WrappedResponse wr) {
        ...
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.limit.TReqLimit reqLimit = classAppReceiver.getOwnClass().getAnnotation(com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.limit.TReqLimit.class);
    ...
    public boolean onPreInvokeMethod(MethodAppReceiver methodAppReceiver, WrappedResponse wr) {
        ...
        com.tagzxia.propguardian.src.main.java.com.talexframe.frame.core.modules.network.connection.app.addon.limit.TReqLimit reqLimit = methodAppReceiver.getMethod().getAnnotation(TReqLimit.class);
