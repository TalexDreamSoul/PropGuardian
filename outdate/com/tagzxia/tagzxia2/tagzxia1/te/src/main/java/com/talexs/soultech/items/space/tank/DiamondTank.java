package com.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.items.space.tank;
 ...
 * <p>
 */
public class DiamondTank extends BaseTank {

    public DiamondTank() {

        super("diamond_tank", 24000);
    ...
    public RecipeObject getRecipe() {
        ...
        return new WorkBenchRecipe("diamond_tank", this)

                .addRequiredNull()
                .addRequiredNull()
                .addRequiredNull()
                .addRequired(new MineCraftItem(Material.DIAMOND_BLOCK))
                .addRequired("tank_gold_tank")
                .addRequired(new MineCraftItem(Material.DIAMOND_BLOCK))
