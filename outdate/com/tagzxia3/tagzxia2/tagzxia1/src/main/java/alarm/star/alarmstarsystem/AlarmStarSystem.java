package com.tagzxia3.tagzxia2.tagzxia1.src.main.java.alarm.star.alarmstarsystem;
...
//        new PrisonCmd().Register();
        ...
        PlaceholderAPI.registerExpansion(papi = new PapiHook());
    }
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if ( i.incrementAndGet() > 15 * 60 ) {
                    ...
                    Listeners.playerSafeList.clear();
