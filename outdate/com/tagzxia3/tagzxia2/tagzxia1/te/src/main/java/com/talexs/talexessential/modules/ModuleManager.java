package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.talexessential.modules;
...
public class ModuleManager {
    ...
    public static Map<Class<? extends BaseModule>, BaseModule> mapper = new HashMap<>();
    ...
    public void allModulesDone() {
        mapper.values().forEach(BaseModule::onAllModulesEnabled);
    }
