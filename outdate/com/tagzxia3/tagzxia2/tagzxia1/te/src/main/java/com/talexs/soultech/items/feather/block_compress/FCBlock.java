package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.items.feather.block_compress;
...
public class FCBlock extends BaseFeatherCompressedItem {
    public FCBlock() {
        super("fc_block", new ItemBuilder(api().getItemHead("21864"))
                .setName("&f轻辉压缩方块")
                .toItemStack());
    }
