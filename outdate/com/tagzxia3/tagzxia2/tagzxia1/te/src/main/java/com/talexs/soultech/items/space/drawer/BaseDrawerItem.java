package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.items.space.drawer;
...
public abstract class BaseDrawerItem extends SoulTechItem implements IHasUnlockConditions, INeedPrepositions {
    public BaseDrawerItem(@NotNull String ID, @NotNull ItemStack stack) {
        super(ID, stack);
    }
    @Override
