package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.items.feather.boots;
 ...
 * <p>
 */
public class FeatherJumperBootPlus extends BaseFeatherItem {

    HashMap<String, Long> CD = new HashMap<>();

    public FeatherJumperBootPlus() {

        super("feather_jumper_boots_plus", new ItemBuilder(Material.NETHERITE_BOOTS)
                .setName("&e轻辉蹦蹦靴 &b&l+")
                .setLore(
                        "",
                        "§8| §a奇妙&7, 无与伦比",
                ...
                .attributeSpeedScale(.15, EquipmentSlot.FEET)
                .toItemStack());
    }
    ...
    public RecipeObject getRecipe() {
        ...
        return new WorkBenchRecipe("jumper_boots_plus", this)
                ...
                .addRequiredNull()
                .addRequired(new MineCraftItem(Material.HONEY_BLOCK))
                .addRequired("feather_jumper_boots")
    ...
    public void onDamaged(PlayerData playerData, EntityDamageEvent event) {
        ...
        if ( event.getCause() == EntityDamageEvent.DamageCause.FALL ) {
            ...
            player.setVelocity(velocity.setY(Math.abs(velocity.getY() * 0.85) + 0.55));
    ...
    public void onSneak(PlayerData playerData, PlayerToggleSneakEvent event) {
        ...
        boolean plusAddon = chestplate != null && chestplate.getType() == Material.ELYTRA;

        player.setFoodLevel((int) ( player.getFoodLevel() * 0.85 ) - 1);

        Vector vector = player.getVelocity();

        player.setVelocity(vector.setY(plusAddon ? 1.95 : 1.85));
    ...
    public Set<IUnlockCondition> getUnlockConditions() {
        return Set.of(new LevelCondition(120), new LevelCondition(8));
    }
}
