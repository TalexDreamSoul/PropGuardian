package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.talexessential.modules.realm.addon;
...
public class RealmAddons {
    ...
    public <T extends IRealmAddon> T getAddon(String key) {
