package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.talexessential.utils.inventory.addon.painter;
...
public class InvUIPainter implements IInvPainter {
    ...
    @Override
    public IInvPainter drawProgressBarHorizontal(int row, int maxWidth, double percent,
    ...
    @Override
    public IInvPainter drawArena9(int slot, IInvClickableItem item) {
    ...
    public IInvPainter drawThese(int... slots) {
    ...
    @Override
    public IInvPainter drawLineRow(int row) {
    ...
    @Override
    public IInvPainter drawLine(int slot) {
    ...
    @Override
    public IInvPainter drawLineRowFull(int row) {
    ...
    @Override
    public IInvPainter drawLineFull(int startSlot) {
