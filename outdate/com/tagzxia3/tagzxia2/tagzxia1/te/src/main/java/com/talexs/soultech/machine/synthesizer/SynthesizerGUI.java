package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.machine.synthesizer;
...
public class SynthesizerGUI extends MachineGUI {

    private CompressorObject co;

    public SynthesizerGUI(CompressorObject co) {
        super("&f高温压缩机");
