package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.items.material.food;
 ...
 * <p>
 */
public class FiredMagicBone extends BaseMaterialItem {

    public FiredMagicBone() {

        super("fired_magic_bone", new ItemBuilder(Material.BONE_MEAL)
                .setName("§5炼制魔法骨粉")
                .addEnchant(Enchantment.ARROW_DAMAGE, 1)
                .addFlag(ItemFlag.HIDE_ENCHANTS)
                .setLore("",
                        "&8| &7对村民使用有 &e5.0% &7的几率催生",
                        "&8| &7对石头使用有 &e20.0% &7的几率变质",
                        "&8| &7对女巫使用有 &e25.0% &7的几率还原",
                        "&8| &7对熔炉加速 &e9600.0% &7在短时间内", "")
                .toItemStack());
    }
    ...
    public RecipeObject getRecipe() {
        ...
        return new FurnaceCauldronRecipe(getID(), this, 15000)
                .setAmount(1)
                .setExport(this)
                .setNeed(SoulTechItem.get("magic_bone"));
...
//                rightClicked.getWorld().playEffect(rightClicked.getLocation(), Effect.VILLAGER_PLANT_GROW, 0);
    ...
    public void onInteract(PlayerData playerData, PlayerInteractEvent event) {
        ...
        if ( type == Material.FURNACE ) {
            ...
            furnace.setCookSpeedMultiplier(96);
            furnace.update();
