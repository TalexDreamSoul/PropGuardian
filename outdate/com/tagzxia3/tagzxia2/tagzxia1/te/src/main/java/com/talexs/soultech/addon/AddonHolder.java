package com.tagzxia3.tagzxia2.tagzxia1.te.src.main.java.com.talexs.soultech.addon;
...
public class AddonHolder {
    ...
    private final Map<Class<? extends BaseAddon>, ISoulTechAddon> mapper = new HashMap<>();

    @Getter
    private static final AddonHolder INSTANCE = new AddonHolder();

    public void register(BaseAddon addon) {
