package com.tagzxia3.tagzxia1.te.src.main.java.com.talexs.soultech.internal.registry;
...
public class RegistryAddon extends BaseAddon {
    ...
    private final Set<IRegistry> registries = new HashSet<>();
    ...
    public void onEnable() {
        ...
        List<IRegistry> _registries = new ArrayList<>(registries);
