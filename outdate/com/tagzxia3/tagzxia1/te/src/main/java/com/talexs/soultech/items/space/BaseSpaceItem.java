package com.tagzxia3.tagzxia1.te.src.main.java.com.talexs.soultech.items.space;
...
public abstract class BaseSpaceItem extends SoulTechItem implements IHasUnlockConditions, INeedPrepositions {
    public BaseSpaceItem(@NotNull String ID, @NotNull ItemStack stack) {
        super(ID, stack);
    }
